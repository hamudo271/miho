  ...
  const signatures = [
    {
      title: '4세대 써마지 FLX',
      desc: '강력한 고주파가 전달하는\n피부 타이트닝의 기준',
      image: 'https://www.toxnfill.com/imges/brand/icon/2025/signature_dummy_1.jpg',
      link: 'https://www.toxnfill.com/brand/detail.php?c=1242&i=5197',
    },
    {
      title: '울쎄라',
      desc: '진피 속 콜라겐 자극과\n리프팅을 한번에!',
      image: 'https://www.toxnfill.com/imges/brand/icon/2025/signature_dummy_2.jpg',
      link: 'https://www.toxnfill.com/brand/detail.php?c=1242&i=5196',
    },
    {
      title: '엑소좀',
      desc: '피부 근본을 튼튼하게 잡아주는\n줄기세포 배양액',
      image: 'https://www.toxnfill.com/imges/brand/icon/2025/signature_dummy_3.jpg',
      link: 'https://www.toxnfill.com/brand/detail.php?c=1245&i=9038',
    },
    {
      title: '쥬베룩',
      desc: '피부에 자연스럽게 스며드는\n볼륨과 탄력',
      image: 'https://www.toxnfill.com/imges/brand/icon/2025/signature_dummy_4.jpg',
      link: 'https://www.toxnfill.com/brand/detail.php?c=1245&i=12708',
    },
    {
      title: '리쥬란 힐러',
      desc: '피부 본연의 재생력을 깨우는 주름개선,\n넘치는 탄력의 시작',
      image: 'https://www.toxnfill.com/imges/brand/icon/2025/signature_dummy_5.jpg',
      link: 'https://www.toxnfill.com/brand/detail.php?c=1245&i=5219',
    },
    {
      title: '슈링크 유니버스',
      desc: '2가지 모드로 더욱 빠르고 강력해진\n초음파 리프팅',
      image: 'https://www.toxnfill.com/imges/brand/icon/2025/signature_dummy_6.jpg',
      link: 'https://www.toxnfill.com/brand/detail.php?c=1242&i=13592',
    },
  ];
